...
class arrive extends StatefulWidget {
  ...
  arrive({required this.value,required this.v});
            ...
            child: FutureBuilder(
                ...
                builder: (context,snapshot){
                  ...
                  if(listes != null){
                          ...
                          if(listes![element]['name'].toString().toLowerCase().startsWith(name.toLowerCase())){
                            return ListTile(
                              title: GestureDetector(
                                onTap: (){
                                  Navigator.push(context,MaterialPageRoute(builder: (context) => navigate(depart:widget.value, arrive:listes![element]['name'], billet: widget.v,)));
                                },
                                child: Row(
                                  children: [
                    ...
                    return Center(child: CircularProgressIndicator(color: Color.fromRGBO(228, 171, 34, 1),));
                  }
                }),
          ),
        ],
